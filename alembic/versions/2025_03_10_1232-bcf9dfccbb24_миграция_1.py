...
Revision ID: bcf9dfccbb24
Revises:
Create Date: 2025-03-10 12:32:04.159500
...
def upgrade() -> None:
    ...
    sa.Column('age_verifid', sa.Boolean(), nullable=False),
    sa.Column('name', sa.String(), nullable=False),
    sa.Column('nickname', sa.String(), nullable=True),
    sa.Column('phone_number', sa.String(), nullable=True),
    sa.Column('prefered_language', sa.Enum('EN', 'RU', name='preferedlanguage'), nullable=False),
